...
<div  class="container">
    <div class="row">
        ...
        <div  class="col-md-6">
            <h1>To complete the order please pay <span> {{$order->total_amount}} </span> Taka only</h1>
        </div>
    </div>
</div>
            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form
                        ...
                        action="{{ route('customer.cart.payment.store') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now ({{$order->total_amount }} Taka)</button>
