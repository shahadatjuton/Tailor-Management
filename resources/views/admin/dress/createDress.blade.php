...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Upload A New Dress Design</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <section class="col-lg-12 ">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{route('admin.dress.store')}}" method="post" id="createDress" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <!-- /.form-group -->
                        ...
                        <div class="form-group col-md-4 offset-5">
                            <a href="{{route('admin.dress.index')}}" class="btn btn-dark">Back</a>
