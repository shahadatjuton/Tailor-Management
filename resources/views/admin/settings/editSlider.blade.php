                ...
                <div class="row">
                    ...
                    <section class="col-lg-12 ">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="imageShow">
                                    <img id="showImage" class=" img-fluid img-circle float-left"
                                         alt="Slider Image"  width="140" height="120" src="{{asset('storage/slider/'.$slider->image)}}">
                                </div>
                            ...
                            <div class="card-body">
                                <form action="{{route('admin.slider.update',$slider->id)}}" method="post" id="createDress" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-row">
                                        <!-- /.form-group -->
                                        ...
                                        <div class="form-group col-md-4 offset-3">
                                            ...
                                            <textarea name="description" rows="4" cols="50">{{$slider->description}}</textarea>
                                        </div>
